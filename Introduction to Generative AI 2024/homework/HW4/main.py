...
class MathSolver:
    ...
    def solve_problem(self, question):
        ...
        """
        system_message = """You are a math expert. Solve the given math problem step by step and provide your final numerical answer clearly. 
        Make sure to show your work and end with a clear statement of your final answer as a number."""
