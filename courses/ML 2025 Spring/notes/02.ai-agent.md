...
- [see this paper to understand how to evaluate how AI Agents continuous improvement over time](https://arxiv.org/abs/2406.08747#)
  - the smarter the agent, the shorter time and less feedback it needs to improve its capability
  - Negative feedback to Agent doesn't help improve performance. Providing information about successfully solved problems is beneficial, while providing information about failed problem-solving attempts does not improve agent capability.
  ![x](./screenshots/feedback-to-llm.png)
...
- numerous tools:
  ...
  - S: build tool retrieval system. Which is similar to the idea of building memory system for learnings from experience
  ![x](./screenshots/retrive-tool.png)
- Agent makes its own tool. A tool is a function in essence
...
- Can LLM Make Plan?
  - LLM can make plan doesn't mean it know what it is doing. It might because it learned the planning content from internet
