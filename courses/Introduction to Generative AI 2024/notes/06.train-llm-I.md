...
- What Knowledge Machine needs to know first
  ...
  - Understand the world, [providing 30 billion data still doesn't work very well](https://arxiv.org/abs/2011.04946) as the understanding of world has different levels.
    ...
    - copyright concerns
- The problem in the GPT 3.0 era - LLMs appear to have learned knowledge but lack the ability to effectively utilize it.
...
- [x] Get clear understanding to `hyperparameter` in ML 2025 course, see [explanation here](https://youtu.be/QLiKmca4kzI?si=q3BydPh4Kc1tRDWG&t=3290).